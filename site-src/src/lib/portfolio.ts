...
const links = {
  ...
  bound: "https://bound-method.github.io/",
  boundDoi: "https://doi.org/10.5281/zenodo.22257583",
...
const faProjects: Project[] = [
  ...
  },
  {
    ...
    subtitle: "معماری عملیات مأموریت",
...
export const faCopy: PortfolioCopy = {
  ...
  role: "مهندس نرم‌افزار و معمار سامانه‌ها",
  authority: "نویسندهٔ روش BOUND نسخهٔ ۳.۰ — توسعهٔ یکپارچهٔ مرز-محور",
  hero: "محصولات نرم‌افزاری، سامانه‌های پیچیده، مهندسی با کمک هوش مصنوعی و روش‌های فنی برای ساخت سیستم‌های قابل اعتماد.",
  heroPrimary: "آشنایی با روش BOUND",
  heroSecondary: "مطالعهٔ انتشار BOUND",
  ...
  methodologyRail: "BOUND / تبار IFEM",
  methodologyHeading: "روش BOUND نسخهٔ ۳.۰ برای مهندسی موازیِ قابل راستی‌آزمایی.",
  methodologyBody: "روش BOUND نسخهٔ ۳.۰ ادامه و پالایش مفهومی IFEM است: دامنه، مرز، قرارداد، اجرای مستقل و راستی‌آزمایی پیوسته. مدل هسته: مرز → قرارداد → اجرای مستقل → راستی‌آزمایی پیوسته. اصل عملیاتی: مرزها را تعریف کنید؛ قراردادها را تثبیت کنید؛ مستقل اجرا کنید؛ پیوسته راستی‌آزمایی کنید. آزادی درون مرزها؛ انضباط میان آن‌ها. این رویکرد هماهنگی فشرده را بر تصمیم‌های مرزی و قراردادی متمرکز می‌کند و وابستگی‌های معمول میان تیم‌ها را در اجرا کاهش می‌دهد. رابط‌ها از مرزها پدید می‌آیند؛ مرزها نباید از روی رابط‌ها حدس زده شوند.",
...
const enProjects: Project[] = [
  ...
  },
  {
    ...
    evidenceLabel: "Mark / mobile-interface evidence", proof: "RezvanMesh marks and mobile interfaces", proofDetail: "The supplied marks and captures document application surfaces only; they do not by themselves establish live mesh behavior, multi-device validation, or a complete product.",
...
export const enCopy: PortfolioCopy = {
  locale: "en",
  nav: { about: "About", work: "Case Studies", methodology: "Methodology", profiles: "Profiles", contact: "Contact" },
  languageLabel: "فارسی",
  languageHref: "/fa/",
  ...
  hero: "I work across software architecture, complex systems, AI-assisted software engineering, and technical-method design to keep boundaries, contracts, and verification paths explicit and traceable.",
  heroPrimary: "Explore BOUND Method",
  heroSecondary: "Read the Publication",
  ...
  methodologyRail: "BOUND / IFEM lineage",
  methodologyHeading: "BOUND Method v3.0 for reliable parallel engineering.",
  methodologyBody: "BOUND Method v3.0 is the renamed continuation and conceptual refinement of IFEM. Core model: Boundary → Contract → Independent Execution → Continuous Verification. Operating principle: Define the boundaries. Freeze the contracts. Execute independently. Verify continuously. Supporting principle: Freedom within boundaries. Discipline across them. This is coordination-bounded engineering: concentrating intensive coordination around architectural boundary and contract decisions while reducing routine cross-team dependency during implementation. Interfaces emerge from boundaries; boundaries should not be inferred from interfaces.",
