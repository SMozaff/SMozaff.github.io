...
export const faCopy: PortfolioCopy = {
  ...
  role: "مهندس نرم‌افزار • معمار سامانه‌ها • خالق IFEM",
  hero: "محصولات نرم‌افزاری، معماری سامانه‌ها و روش‌های مهندسی برای ساخت سیستم‌های قابل توسعه و قابل اعتماد.",
  heroPrimary: "مرور نمونه‌کارها",
  heroSecondary: "ورود به IFEM",
...
export const enCopy: PortfolioCopy = {
  ...
  localizedName: "",
  role: "Software engineer • systems architect • creator of IFEM",
  ...
  heroSecondary: "Explore IFEM Doctrine",
